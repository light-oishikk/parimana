...
\toprule
\textbf{Reference} & \textbf{Architecture} & \textbf{Image Size} & \textbf{Sampling Ratio} & \textbf{Data Type} & \textbf{Key Contribution} \\
\midrule
\citet{lyu2017}       & Fully connected  & $28\times28$   & 12.5\%  & Simulated     & First DL ghost imaging \\
\citet{he2018}        & CNN              & $28\times28$   & $<$10\% & Sim.\ + Expt. & Improved generalisation \\
\citet{shimobaba2018} & CNN              & $64\times64$   & 25\%    & Simulated     & Computational GI focus \\
\citet{wang2019}      & End-to-end CNN   & $64\times64$   & 6.25\%  & Simulated     & Joint pattern--network opt. \\
\bottomrule
\end{tabular}
\end{table*}
